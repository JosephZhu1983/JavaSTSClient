 ...
 * API总体情况的统计信息
 */
public class GeneralApiStatistics implements ReportApiStatisticsCallback
{
    private final Object throughputCalculationLock = new Object();
    private final Map<String, ApiStatistics> apiStatisticsList = new HashMap<String, ApiStatistics>();
    ...
    public Object getThroughputCalculationLock()
    {
        return throughputCalculationLock;
    }
    ...
    public Map<String, ApiStatistics> getApiStatisticsList()
    {
    ...
    public void updateThroughput(long intervalSeconds)
    {
        ...
        {
            for (ApiStatistics apiStatistics : apiStatisticsList.values())
            {
                apiStatistics.updateThroughput(intervalSeconds);
            }
    ...
    public void sendRequest(String name)
    {
        ...
        synchronized (apiStatisticsList)
        {
            ApiStatistics apiStatistics = apiStatisticsList.get(name);
            if (apiStatistics == null)
            {
                apiStatistics = new ApiStatistics();
                apiStatisticsList.put(name, apiStatistics);
            }
            apiStatistics.sendRequest();
        }
    }

    public void receiveSuccessResponse(String name, int time)
    {
        if (!enable) return;
        ...
        synchronized (apiStatisticsList)
        {
            ...
            apiStatistics.receiveSuccessResponse(time);
        }

    }

    public void receiveErrorResponse(String name)
    {
        if (!enable) return;
        ...
        synchronized (apiStatisticsList)
        {
            ...
            apiStatistics.receiveErrorResponse();
        }
    }

    public void receiveSuccessRequest(String name)
    {
        if (!enable) return;
        ...
        synchronized (apiStatisticsList)
        {
            ...
            apiStatistics.receiveSuccessRequest();
        }
    }

    public void receiveErrorRequest(String name)
    {
        if (!enable) return;
        ...
        synchronized (apiStatisticsList)
        {
            ...
            apiStatistics.receiveErrorRequest();
        }
    }

    public void sendSuccessResponse(String name, int time)
    {
        if (!enable) return;
        ...
        synchronized (apiStatisticsList)
        {
            ...
            apiStatistics.sendSuccessResponse(time);
        }
    }

    public void sendErrorResponse(String name)
    {
        if (!enable) return;
        ...
        synchronized (apiStatisticsList)
        {
            ...
            apiStatistics.sendErrorResponse();
        }
    }
